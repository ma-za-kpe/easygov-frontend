        ...
        <div className="space-y-8">
              ...
              <div className="relative text-center md:text-left space-y-6 max-w-3xl mx-auto md:mx-0">
                ...
                <div className="flex flex-col md:flex-row justify-center md:justify-start items-center gap-4 md:gap-6">
                  <div className="flex items-center space-x-3 w-full md:w-auto">
                    <label className="flex items-center text-sm font-medium whitespace-nowrap" htmlFor="region-select">
              ...
              <div className="text-center py-12 bg-white rounded-lg shadow-md">
                {searchTerm ? (
                  <>
                    ...
                    <p className="text-sm text-gray-500 mt-2">Try different keywords or clear your search</p>
                  </>
                ) : (
                  <>
                    <div className="text-4xl mb-3">📑</div>
                    <p className="text-lg text-gray-600">No summaries found for this region and language.</p>
                    <p className="text-sm text-gray-500 mt-2">
                      ...
                      >
                        Suggest a document
                      </button> or try a different region.
                    </p>
                  </>
                )}
              </div>
          ...
          <div className="bg-teal-50 rounded-xl p-6 shadow-sm text-center my-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-6">
              Help us expand our collection by suggesting government documents that matter to you and your community.
            </p>
            <button 
              onClick={openModal}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-200 mb-4">
                WaziGov empowers women and communities with clear, accessible government document summaries, 
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <button onClick={openModal} className="text-gray-200 hover:text-white flex items-center">
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">
                Have a policy or law you want summarized? Share it with us and help make government information more accessible.
              </p>
